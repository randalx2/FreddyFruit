...
public class NVPAPICaller
{
    ...
    public string APIUsername = "flashgordonx2-facilitator_api1.gmail.com";
    private string APIPassword = "FB2GX3Z9QM3FKLJF";
    private string APISignature = "AUK9wrtQWuNVERgZdsILxXQAJRGVA8sYEFE3JmVxL..fmvUFQjjdFf8N";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44372/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44372/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "Freddy Fruits Sample Application";
        ...
        using (FreddyFruit.Logic.ShoppingCartActions myCartOrders = new FreddyFruit.Logic.ShoppingCartActions())
        {
